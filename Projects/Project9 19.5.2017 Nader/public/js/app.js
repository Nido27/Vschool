var app = angular.module("myApp", ["ngRoute", "todoReqModule", "app.Homemodule", "app.SignUp", "authModule", "tokenModule", "app.signin", "app.AdminRole", "app.addOffear", "app.addHotel", "app.Fall", "app.Spring", "app.Summer", "app.Winter", "app.Hotels", "app.User"]);
...
app.service("AuthInterceptor", ["$q", "$location", "TokenService", function ($q, $location, TokenService, privService, IdService, UsernameService, UserImgService) {
...
app.controller("Index", function ($scope, authSerivce, todoReq, privService, IdService, TokenService, $routeParams, $location, UsernameService, UserImgService) {
    $scope.UserImg = UserImgService.getImg();
    $scope.UserById = IdService.getId();
    ...
    $scope.navref = function () {
        ...
        $scope.Img = UserImgService.getImg();
    }
    ...
    $scope.signin = function () {
        authSerivce.signin($scope.userinput).then(function (response) {
            ...
            UserImgService.setImg(response.data.image);
